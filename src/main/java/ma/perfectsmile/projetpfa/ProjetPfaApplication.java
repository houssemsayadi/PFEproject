...
public class ProjetPfaApplication {
    ...
    CommandLineRunner commandLineRunner(SecretaireServiceImpl secretaireService, SpecialiteServiceImpl specialiteService, PatientServiceImpl patientService, RoleServiceImpl roleService) {
        return args -> {
            ...
            secretaire.setNom("houssem");
            secretaire.setPrenom("sayadi");
            secretaire.setEmail("houssemsayadi@gmail.com");
            secretaire.setAdresse("monastir,tunisia");
            ...
            patient.setNom("IMEN");
            patient.setPrenom("STAMBOULI");
            patient.setEmail("imenstambouli@gmail.com");
            patient.setAdresse("Monastir, Tunisia");
